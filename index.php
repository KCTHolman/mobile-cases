...
<?php include "projects/navbar/navbar.php"; ?>
    ...
    <div class="box4-products">
        <div class="products-mobile debug">
            <div class="mobile-img debug">
                <img src="images/mobile/iPhoneXsMax_480x.jpg"></div>
            <div class="mobile-text debug">Iphone XS Max</div>
        </div>
    ...
    <div class="box6-reviews">
        <div class="reviews-item">
            ...
            <div class="review-text">"The X-Doria cases are slim, stylish, and protective, and basically offer everything I look for in a case. "
        ...
        <div class="reviews-item">
            ...
            <div class="review-text">"I really liked the X-Doria Defense Lux case I tested out for the iPhone 6/6s.
                    ...
                    The company is going all out with new cases for the iPhone X. The iPhone X Case Defense Shield -one of the samples sitting on my desk right now - offers military grade drop protection to keep that glass from shattering."
                    
                    — Forbes</div>
        </div>
        <div class="reviews-item">
            <div class="review-img"><img src="images/reviews/logo_techradar_400x@2x.png"></div>
            <div class="review-text">"Protection for your pricey iPhone 8 can come at a high cost, but it doesn’t have to. The X-Doria Defense Clear case costs less than most ruggedized cases.This case is no frills, but if all you’re looking for is protection on the cheap, look no further."
